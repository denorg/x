console.warn("[DEPRECATION NOTICE] - This module (deno-task-runner-v2) will be deprecated and removed on the 20th of May, 2020. As an alternative, you can use denon");
