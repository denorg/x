...
export function dew() {
  ...
  _dewExec = true;
  !function (u, D) {
    "object" == typeof exports && true ? exports = D() : "function" == typeof define && define.amd ? define(D) : u.JSON5 = D();
  }(exports, function () {
    "use strict";
    ...
    var D = u(function (u) {
      ...
      "number" == typeof _global.__g && (_global.__g = __g = D);
    }),
        e = u(function (u) {
      var D = u.exports = {
        version: "2.5.7"
      };
      "number" == typeof _global.__e && (_global.__e = __e = D);
    }),
      ...
      e.inspectSource = function (u) {
        ...
        return "function" == typeof (this || _global) && (this || _global)[r] || F.call(this || _global);
      });
    }),
        d = function (u, D, e) {
      if (function (u) {
    ...
    return {
      ...
      stringify: function (u, D, e) {
        ...
        function s(u) {
          ...
          for (var e = D.length; e < u.length; e++) if (!G.isIdContinueChar(String.fromCodePoint(u.codePointAt(e)))) return B(u);
