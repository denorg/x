...
export function dew() {
  ...
  _dewExec = true;
  !function (t, n) {
    "object" == typeof exports && true ? exports = n() : "function" == typeof define && define.amd ? define(n) : t.dayjs_plugin_quarterOfYear = n();
  }(exports, function () {
    "use strict";
    ...
    return function (r, i) {
      ...
      e.add = function (r, i) {
        return r = Number(r), this.$utils().p(i) === n ? this.add(3 * r, t) : u.bind(this || _global)(r, i);
      };
      ...
      e.startOf = function (r, i) {
        ...
        return s.bind(this || _global)(r, i);
      };
    };
  });
  return exports;
