  ...
  (function (global, factory) {
    ...
    ************************************/
    ...
    numeral.register = function (type, name, format) {
      ...
      if ((this || _global)[type + 's'][name]) {
        throw new TypeError(name + ' ' + type + ' already registered.');
      }

      (this || _global)[type + 's'][name] = format;
      return format;
    };
    ...
    ************************************/
    ...
    numeral.fn = Numeral.prototype = {
      clone: function () {
        return numeral(this || _global);
      },
      format: function (inputString, roundingFunction) {
        var value = (this || _global)._value,
      ...
      set: function (value) {
        (this || _global)._value = Number(value);
        return this || _global;
      },
      add: function (value) {
        var corrFactor = _.correctionFactor.call(null, (this || _global)._value, value);

        function cback(accum, curr, currI, O) {
          return accum + Math.round(corrFactor * curr);
        }

        (this || _global)._value = _.reduce([(this || _global)._value, value], cback, 0) / corrFactor;
        return this || _global;
      },
      subtract: function (value) {
        ...
        (this || _global)._value = _.reduce([value], cback, Math.round((this || _global)._value * corrFactor)) / corrFactor;
        return this || _global;
      },
      multiply: function (value) {
        ...
        (this || _global)._value = _.reduce([(this || _global)._value, value], cback, 1);
        return this || _global;
      },
      divide: function (value) {
        ...
        (this || _global)._value = _.reduce([(this || _global)._value, value], cback);
        return this || _global;
      },
      difference: function (value) {
        return Math.abs(numeral((this || _global)._value).subtract(value).value());
      }
    };
    /************************************
