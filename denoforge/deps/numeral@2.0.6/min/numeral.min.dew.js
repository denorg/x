...
export function dew() {
   ...
   */
  !function (a, b) {
    "function" == typeof define && define.amd ? define(b) : exports ? exports = b() : a.numeral = b();
  }(exports, function () {
    function a(a, b) {
      (this || _global)._input = a, (this || _global)._value = b;
    }
    ...
    return b = function (d) {
      var f, g, i, j;
      if (b.isNumeral(d)) f = d.value();else if (0 === d || "undefined" == typeof d) f = 0;else if (null === d || c.isNaN(d)) f = null;else if ("string" == typeof d) {
      ...
      reduce: function (a, b) {
        if (null === (this || _global)) throw new TypeError("Array.prototype.reduce called on null or undefined");
      ...
      if (b = b.toLowerCase(), (this || _global)[a + "s"][b]) throw new TypeError(b + " " + a + " already registered.");
      return (this || _global)[a + "s"][b] = c, c;
      ...
      clone: function () {
        return b(this || _global);
      },
      format: function (a, c) {
        var d,
            f,
            g,
            i = (this || _global)._value,
            j = a || h.defaultFormat;
      ...
      input: function () {
        return (this || _global)._input;
      },
      set: function (a) {
        return (this || _global)._value = Number(a), this || _global;
      },
      add: function (a) {
        function b(a, b, c, e) {
        ...
        var d = c.correctionFactor.call(null, (this || _global)._value, a);
        return (this || _global)._value = c.reduce([(this || _global)._value, a], b, 0) / d, this || _global;
      },
      subtract: function (a) {
        function b(a, b, c, e) {
          return a - Math.round(d * b);
        ...
        var d = c.correctionFactor.call(null, (this || _global)._value, a);
        return (this || _global)._value = c.reduce([a], b, Math.round((this || _global)._value * d)) / d, this || _global;
      },
      multiply: function (a) {
        function b(a, b, d, e) {
        ...
        return (this || _global)._value = c.reduce([(this || _global)._value, a], b, 1), this || _global;
      },
      divide: function (a) {
        function b(a, b, d, e) {
          var f = c.correctionFactor(a, b);
        ...
        return (this || _global)._value = c.reduce([(this || _global)._value, a], b), this || _global;
      },
      difference: function (a) {
        return Math.abs(b((this || _global)._value).subtract(a).value());
      }
