...
export function dew() {
  ...
  exports = function (grunt) {
    var compileType = function () {
      var type = (this || _global).data.type;
    ...
    grunt.initConfig({
      ...
      karma: {
        options: {
          files: ['numeral.js', 'locales.js', 'tests/numeral.js', 'tests/formats/*.js', 'tests/locales/*.js'],
    ...
    grunt.registerTask('version', function (version) {
      ...
      grunt.task.run(['string-replace:json', 'string-replace:templates', 'string-replace:numeral']);
    }); // Travis CI task.
