...
export function dew() {
  ...
  $(function () {
    $('#submit-parse').click(function () {
      ...
      var config = buildConfig(); // NOTE: Chunk size does not get reset if changed and then set back to empty/default value
  ...
  function completeFn() {
    ...
    if (!$('#stream').prop('checked') && !$('#chunk').prop('checked') && arguments[0] && arguments[0].data) rows = arguments[0].data.length;
