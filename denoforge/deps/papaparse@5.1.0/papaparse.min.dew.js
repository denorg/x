...
export function dew() {
  ...
  */
  !function (e, t) {
    "function" == typeof define && define.amd ? define([], t) : "undefined" != typeof exports ? exports = t() : e.Papa = t();
  }(exports, function s() {
    "use strict";
    ...
    if (b.RECORD_SEP = String.fromCharCode(30), b.UNIT_SEP = String.fromCharCode(31), b.BYTE_ORDER_MARK = "\ufeff", b.BAD_DELIMITERS = ["\r", "\n", '"', b.BYTE_ORDER_MARK], b.WORKERS_SUPPORTED = !n && !!f.Worker, b.NODE_STREAM_INPUT = 1, b.LocalChunkSize = 10485760, b.RemoteChunkSize = 5242880, b.DefaultDelimiter = ",", b.Parser = E, b.ParserHandle = r, b.NetworkStreamer = l, b.FileStreamer = c, b.StringStreamer = p, b.ReadableStreamStreamer = m, f.jQuery) {
      ...
      d.fn.parse = function (o) {
        ...
        return this.each(function (e) {
          if (!("INPUT" === d(this || _global).prop("tagName").toUpperCase() && "file" === d(this || _global).attr("type").toLowerCase() && f.FileReader) || !(this || _global).files || 0 === (this || _global).files.length) return !0;

          for (var t = 0; t < (this || _global).files.length; t++) h.push({
            file: (this || _global).files[t],
    ...
    function u(e) {
      (this || _global)._handle = null, (this || _global)._finished = !1, (this || _global)._completed = !1, (this || _global)._halted = !1, (this || _global)._input = null, (this || _global)._baseIndex = 0, (this || _global)._partialLine = "", (this || _global)._rowCount = 0, (this || _global)._start = 0, (this || _global)._nextChunk = null, (this || _global).isFirstChunk = !0, (this || _global)._completeResults = {
        data: [],
        errors: [],
        meta: {}
      }, function (e) {
        ...
        (this || _global)._handle = new r(t), ((this || _global)._handle.streamer = this || _global)._config = t;
      }.call(this || _global, e), (this || _global).parseChunk = function (e, t) {
        if ((this || _global).isFirstChunk && q((this || _global)._config.beforeFirstChunk)) {
          var r = (this || _global)._config.beforeFirstChunk(e);

          void 0 !== r && (e = r);
        }

        (this || _global).isFirstChunk = !1, (this || _global)._halted = !1;
        var i = (this || _global)._partialLine + e;
        (this || _global)._partialLine = "";

        var n = (this || _global)._handle.parse(i, (this || _global)._baseIndex, !(this || _global)._finished);

        if (!(this || _global)._handle.paused() && !(this || _global)._handle.aborted()) {
          var s = n.meta.cursor;
          (this || _global)._finished || ((this || _global)._partialLine = i.substring(s - (this || _global)._baseIndex), (this || _global)._baseIndex = s), n && n.data && ((this || _global)._rowCount += n.data.length);
          var a = (this || _global)._finished || (this || _global)._config.preview && (this || _global)._rowCount >= (this || _global)._config.preview;
          if (o) f.postMessage({
            results: n,
            workerId: b.WORKER_ID,
            finished: a
          });else if (q((this || _global)._config.chunk) && !t) {
            if ((this || _global)._config.chunk(n, (this || _global)._handle), (this || _global)._handle.paused() || (this || _global)._handle.aborted()) return void ((this || _global)._halted = !0);
            n = void 0, (this || _global)._completeResults = void 0;
          }
          return (this || _global)._config.step || (this || _global)._config.chunk || ((this || _global)._completeResults.data = (this || _global)._completeResults.data.concat(n.data), (this || _global)._completeResults.errors = (this || _global)._completeResults.errors.concat(n.errors), (this || _global)._completeResults.meta = n.meta), (this || _global)._completed || !a || !q((this || _global)._config.complete) || n && n.meta.aborted || ((this || _global)._config.complete((this || _global)._completeResults, (this || _global)._input), (this || _global)._completed = !0), a || n && n.meta.paused || this._nextChunk(), n;
        }

        (this || _global)._halted = !0;
      }, (this || _global)._sendError = function (e) {
        q((this || _global)._config.error) ? (this || _global)._config.error(e) : o && (this || _global)._config.error && f.postMessage({
          workerId: b.WORKER_ID,
          error: e,
          finished: !1
        });
    ...
    function l(e) {
      var i;
      (e = e || {}).chunkSize || (e.chunkSize = b.RemoteChunkSize), u.call(this || _global, e), (this || _global)._nextChunk = n ? function () {
        this._readChunk(), this._chunkLoaded();
      } : function () {
        this._readChunk();
      }, (this || _global).stream = function (e) {
        (this || _global)._input = e, this._nextChunk();
      }, (this || _global)._readChunk = function () {
        if ((this || _global)._finished) this._chunkLoaded();else {
          if (i = new XMLHttpRequest(), (this || _global)._config.withCredentials && (i.withCredentials = (this || _global)._config.withCredentials), n || (i.onload = y((this || _global)._chunkLoaded, this || _global), i.onerror = y((this || _global)._chunkError, this || _global)), i.open("GET", (this || _global)._input, !n), (this || _global)._config.downloadRequestHeaders) {
            var e = (this || _global)._config.downloadRequestHeaders;

            for (var t in e) i.setRequestHeader(t, e[t]);
          }

          if ((this || _global)._config.chunkSize) {
            var r = (this || _global)._start + (this || _global)._config.chunkSize - 1;
            i.setRequestHeader("Range", "bytes=" + (this || _global)._start + "-" + r);
          }
        ...
        4 === i.readyState && (i.status < 200 || 400 <= i.status ? this._chunkError() : ((this || _global)._start += i.responseText.length, (this || _global)._finished = !(this || _global)._config.chunkSize || (this || _global)._start >= function (e) {
          var t = e.getResponseHeader("Content-Range");
          if (null === t) return -1;
          return parseInt(t.substr(t.lastIndexOf("/") + 1));
        }(i), this.parseChunk(i.responseText)));
      }, (this || _global)._chunkError = function (e) {
    ...
    function c(e) {
      var i, n;
      (e = e || {}).chunkSize || (e.chunkSize = b.LocalChunkSize), u.call(this || _global, e);
      var s = "undefined" != typeof FileReader;
      (this || _global).stream = function (e) {
        (this || _global)._input = e, n = e.slice || e.webkitSlice || e.mozSlice, s ? ((i = new FileReader()).onload = y((this || _global)._chunkLoaded, this || _global), i.onerror = y((this || _global)._chunkError, this || _global)) : i = new FileReaderSync(), this._nextChunk();
      }, (this || _global)._nextChunk = function () {
        (this || _global)._finished || (this || _global)._config.preview && !((this || _global)._rowCount < (this || _global)._config.preview) || this._readChunk();
      }, (this || _global)._readChunk = function () {
        var e = (this || _global)._input;

        if ((this || _global)._config.chunkSize) {
          var t = Math.min((this || _global)._start + (this || _global)._config.chunkSize, (this || _global)._input.size);
          e = n.call(e, (this || _global)._start, t);
        }

        var r = i.readAsText(e, (this || _global)._config.encoding);
        s || this._chunkLoaded({
          target: {
            result: r
          }
        });
      }, (this || _global)._chunkLoaded = function (e) {
        (this || _global)._start += (this || _global)._config.chunkSize, (this || _global)._finished = !(this || _global)._config.chunkSize || (this || _global)._start >= (this || _global)._input.size, this.parseChunk(e.target.result);
    ...
    function p(e) {
      var r;
      u.call(this || _global, e = e || {}), (this || _global).stream = function (e) {
        return r = e, this._nextChunk();
      }, (this || _global)._nextChunk = function () {
        if (!(this || _global)._finished) {
          var e = (this || _global)._config.chunkSize,
              t = e ? r.substr(0, e) : r;
          return r = e ? r.substr(e) : "", (this || _global)._finished = !r, this.parseChunk(t);
        }
      };
    }

    function m(e) {
      u.call(this || _global, e = e || {});
      var t = [],
          r = !0,
          i = !1;
      (this || _global).pause = function () {
        u.prototype.pause.apply(this || _global, arguments), (this || _global)._input.pause();
      }, (this || _global).resume = function () {
        u.prototype.resume.apply(this || _global, arguments), (this || _global)._input.resume();
      }, (this || _global).stream = function (e) {
        (this || _global)._input = e, (this || _global)._input.on("data", (this || _global)._streamData), (this || _global)._input.on("end", (this || _global)._streamEnd), (this || _global)._input.on("error", (this || _global)._streamError);
      }, (this || _global)._checkIsFinished = function () {
        i && 1 === t.length && ((this || _global)._finished = !0);
      }, (this || _global)._nextChunk = function () {
        this._checkIsFinished(), t.length ? this.parseChunk(t.shift()) : r = !0;
      }, (this || _global)._streamData = y(function (e) {
        try {
          t.push("string" == typeof e ? e : e.toString((this || _global)._config.encoding)), r && (r = !1, this._checkIsFinished(), this.parseChunk(t.shift()));
        } catch (e) {
          this._streamError(e);
        }
      }, this || _global), (this || _global)._streamError = y(function (e) {
        this._streamCleanUp(), this._sendError(e);
      }, this || _global), (this || _global)._streamEnd = y(function () {
        this._streamCleanUp(), i = !0, this._streamData("");
      }, this || _global), (this || _global)._streamCleanUp = y(function () {
        (this || _global)._input.removeListener("data", (this || _global)._streamData), (this || _global)._input.removeListener("end", (this || _global)._streamEnd), (this || _global)._input.removeListener("error", (this || _global)._streamError);
      }, this || _global);
    }
    ...
    function r(g) {
      ...
      (this || _global).parse = function (e, t, r) {
        var i = g.quoteChar || '"';
        ...
        t.streamer._halted ? (d = !1, t.streamer.parseChunk(a, !0)) : setTimeout((this || _global).resume, 3);
    ...
    function E(e) {
      ...
      var z = 0,
          j = !1;
      (this || _global).parse = function (a, r, t) {
