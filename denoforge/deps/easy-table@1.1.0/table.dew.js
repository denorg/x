import { dew as _indexDewDew } from "../wcwidth@1.0.1/index.dew.js";
var exports = {},
    _dewExec = false;
...
export function dew() {
  ...
  Table.prototype.newRow = function () {
    (this || _global).rows.push((this || _global).row);
  ...
  Table.prototype.cell = function (col, val, printer) {
    (this || _global).row[col] = val;
    (this || _global).row.__printers[col] = printer || string;
    return this || _global;
  };
  /**
  ...
  Table.prototype.columns = function () {
    ...
    for (var i = 0; i < 2; i++) {
      // do 2 times
      (this || _global).rows.forEach(function (row) {
        var idx = 0;
  ...
  Table.prototype.print = function () {
    ...
    var separator = (this || _global).separator;
    var widths = {};
    var out = ''; // Calc widths
  ...
  Table.prototype.toString = function () {
    ...
    out.separator = (this || _global).separator; // Write header
    ...
    out.rows = out.rows.concat((this || _global).rows); // Totals

    if ((this || _global).totals && (this || _global).rows.length) {
  ...
  Table.prototype.forEachTotal = function (cb) {
    for (var key in (this || _global).totals) {
      var aggr = (this || _global).totals[key];
      var acc = aggr.init;
      var len = (this || _global).rows.length;

      (this || _global).rows.forEach(function (row, idx) {
  ...
  Table.prototype.printTransposed = function (opts) {
    opts = opts || {};
    var out = new Table();
    out.separator = opts.separator || (this || _global).separator;
  ...
  Table.prototype.total = function (col, opts) {
    opts = opts || {};
    (this || _global).totals = (this || _global).totals || {};
    (this || _global).totals[col] = {
